...
public class GetirCase3Bug2 extends CapabilitiesClass {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		try {
			...
			driver.findElementByXPath("//android.widget.TextView[@text='Wishlist']").click();
			
		}catch (Exception e) {
			System.out.println("Wishlist butonu tıklanmıyor!");
		}
